...
val LightIconPack.IcMuteLight: ImageVector
    get() {
        if (_icMuteLight != null) {
            return _icMuteLight!!
        }
        _icMuteLight = Builder(
            name = "IcMuteLight", defaultWidth = 16.0.dp, defaultHeight =
...
private var _icMuteLight: ImageVector? = null
