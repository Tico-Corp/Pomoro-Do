...
val DarkIconPack.IcSoundDark: ImageVector
    get() {
        if (_icSoundDark != null) {
            return _icSoundDark!!
        }
        _icSoundDark = Builder(
            name = "IcSoundDark", defaultWidth = 16.0.dp, defaultHeight =
...
private var _icSoundDark: ImageVector? = null
