...
val LightIconPack.IcTodoCheckedLight: ImageVector
    get() {
        if (_icTodoCheckedLight != null) {
            return _icTodoCheckedLight!!
        }
        _icTodoCheckedLight = Builder(
            name = "IcTodoCheckedLight", defaultWidth = 96.0.dp,
...
private var _icTodoCheckedLight: ImageVector? = null
