...
val LightIconPack.IcGroupSelectedCancleLight: ImageVector
    get() {
        if (_icGroupSelectedCancleLight != null) {
            return _icGroupSelectedCancleLight!!
        }
        _icGroupSelectedCancleLight = Builder(
            name = "IcGroupSelectedCancleLight", defaultWidth =
...
private var _icGroupSelectedCancleLight: ImageVector? = null
