...
val DarkIconPack.IcArrowBackDark: ImageVector
    get() {
        if (_icArrowBackDark != null) {
            return _icArrowBackDark!!
        }
        _icArrowBackDark = Builder(
...
private var _icArrowBackDark: ImageVector? = null
