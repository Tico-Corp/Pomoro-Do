...
val DarkIconPack.IcTimelineMoreDark: ImageVector
    get() {
        if (_icTimelineMoreDark != null) {
            return _icTimelineMoreDark!!
        }
        _icTimelineMoreDark = Builder(
            name = "IcTimelineMoreDark", defaultWidth = 18.0.dp,
            defaultHeight = 18.0.dp, viewportWidth = 18.0f, viewportHeight = 18.0f
        ).apply {
            group {
                path(
                    fill = SolidColor(Color(0xFFA58C7B)), stroke = null, strokeLineWidth = 0.0f,
...
private var _icTimelineMoreDark: ImageVector? = null
