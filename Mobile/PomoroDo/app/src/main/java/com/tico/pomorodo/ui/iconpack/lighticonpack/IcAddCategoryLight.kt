...
val LightIconPack.IcAddCategoryLight: ImageVector
    get() {
        if (_icAddCategoryLight != null) {
            return _icAddCategoryLight!!
        }
        _icAddCategoryLight = Builder(
            name = "IcAddCategoryLight", defaultWidth = 14.0.dp, defaultHeight =
...
private var _icAddCategoryLight: ImageVector? = null
