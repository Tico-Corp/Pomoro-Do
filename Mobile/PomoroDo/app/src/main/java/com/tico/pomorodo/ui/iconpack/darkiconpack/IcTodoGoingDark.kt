...
val DarkIconPack.IcTodoGoingDark: ImageVector
    get() {
        if (_icTodoGoingDark != null) {
            return _icTodoGoingDark!!
        }
        _icTodoGoingDark = Builder(
            name = "IcTodoGoingDark", defaultWidth = 96.0.dp, defaultHeight =
...
private var _icTodoGoingDark: ImageVector? = null
