...
val DarkIconPack.IcTodoUncheckedDark: ImageVector
    get() {
        if (_icTodoUncheckedDark != null) {
            return _icTodoUncheckedDark!!
        }
        _icTodoUncheckedDark = Builder(
            name = "IcTodoUncheckedDark", defaultWidth = 96.0.dp,
...
private var _icTodoUncheckedDark: ImageVector? = null
