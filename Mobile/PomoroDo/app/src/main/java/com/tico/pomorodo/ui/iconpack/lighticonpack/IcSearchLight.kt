...
val IcSearchLight: ImageVector
    get() {
        if (_icSearchLight != null) {
            return _icSearchLight!!
        }
        _icSearchLight = Builder(
            name = "IcSearchLight", defaultWidth = 24.0.dp, defaultHeight =
...
private var _icSearchLight: ImageVector? = null
