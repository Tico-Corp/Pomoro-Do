...
val LightIconPack.IcDropDownDisableLight: ImageVector
    get() {
        if (_icDropDownDisableLight != null) {
            return _icDropDownDisableLight!!
        }
        _icDropDownDisableLight = Builder(
            name = "IcDropDownDisableLight", defaultWidth = 15.0.dp,
...
private var _icDropDownDisableLight: ImageVector? = null
