...
val LightIconPack.IcAllCleanLight: ImageVector
    get() {
        if (_icAllCleanLight != null) {
            return _icAllCleanLight!!
        }
        _icAllCleanLight = Builder(
            name = "IcAllCleanLight", defaultWidth = 32.0.dp, defaultHeight =
...
private var _icAllCleanLight: ImageVector? = null
