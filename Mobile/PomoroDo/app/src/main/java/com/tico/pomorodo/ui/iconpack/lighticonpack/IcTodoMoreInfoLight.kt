...
val LightIconPack.IcTodoMoreInfoLight: ImageVector
    get() {
        if (_icTodoMoreInfo != null) {
            return _icTodoMoreInfo!!
        }
        _icTodoMoreInfo = Builder(
            name = "IcTodoMoreInfoLight", defaultWidth = 15.0.dp, defaultHeight =
...
private var _icTodoMoreInfo: ImageVector? = null
