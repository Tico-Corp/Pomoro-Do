...
val DarkIconPack.IcVibrateDark: ImageVector
    get() {
        if (_icVibrateDark != null) {
            return _icVibrateDark!!
        }
        _icVibrateDark = Builder(
            name = "IcVibrateDark", defaultWidth = 16.0.dp, defaultHeight =
...
private var _icVibrateDark: ImageVector? = null
