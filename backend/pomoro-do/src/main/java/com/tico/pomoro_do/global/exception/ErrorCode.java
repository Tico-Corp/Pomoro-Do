...
public enum ErrorCode {
    ...
    INVALID_START_DATE(HttpStatus.BAD_REQUEST, "C-613", "카테고리 시작일이 유효하지 않습니다."),
    INVALID_CATEGORY_VISIBILITY(HttpStatus.BAD_REQUEST, "C-614", "카테고리 공개 설정이 유효하지 않습니다."),

    // 그룹 카테고리 관련 에러: -630번대
    NOT_GROUP_CATEGORY(HttpStatus.BAD_REQUEST, "C-630", "그룹 카테고리가 아닙니다."),
    CATEGORY_VISIBILITY_UPDATE_FORBIDDEN(HttpStatus.FORBIDDEN, "C-631", "그룹 카테고리의 공개 설정은 수정할 수 없습니다."),
    ...
    INVITATION_NOT_FOUND(HttpStatus.NOT_FOUND, "CI-671", "해당 초대 정보를 찾을 수 없습니다."),
    DUPLICATE_INVITATION(HttpStatus.BAD_REQUEST, "CI-672", "이미 초대된 사용자입니다."),
    INVITATION_ALREADY_RESPONDED(HttpStatus.BAD_REQUEST, "CI-673", "이미 응답한 초대입니다."),
    ALREADY_CATEGORY_MEMBER(HttpStatus.BAD_REQUEST, "CI-674", "이미 카테고리 멤버인 사용자입니다."),
    NOT_INVITEE(HttpStatus.FORBIDDEN, "CI-675", "해당 초대에 응답할 권한이 없습니다."),
    CATEGORY_MEMBER_NOT_FOLLOWED(HttpStatus.BAD_REQUEST, "CI-676", "팔로우하지 않은 사용자는 그룹에 초대할 수 없습니다."),
