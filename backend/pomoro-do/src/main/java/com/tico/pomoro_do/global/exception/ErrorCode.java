...
public enum ErrorCode {
    ...
    CATEGORY_DELETE_FORBIDDEN(HttpStatus.FORBIDDEN, "C-612", "카테고리를 삭제할 권한이 없습니다."),
    ...
    CATEGORY_UPDATE_FORBIDDEN(HttpStatus.FORBIDDEN, "C-615", "카테고리를 수정할 권한이 없습니다."),
    CATEGORY_VISIBILITY_UPDATE_FORBIDDEN(HttpStatus.FORBIDDEN, "C-616", "그룹 카테고리의 공개 설정은 수정할 수 없습니다."),

    INVALID_CATEGORY_NAME(HttpStatus.BAD_REQUEST, "C-620", "카테고리 이름이 유효하지 않습니다."),
    INVALID_CATEGORY_TYPE(HttpStatus.BAD_REQUEST, "C-621", "카테고리 유형이 유효하지 않습니다."),
    INVALID_START_DATE(HttpStatus.BAD_REQUEST, "C-622", "카테고리 시작일이 유효하지 않습니다."),
    INVALID_CATEGORY_VISIBILITY(HttpStatus.BAD_REQUEST, "C-623", "카테고리 공개 설정이 유효하지 않습니다."),
